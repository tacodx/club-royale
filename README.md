...
An art-deco casino for **Scratch 3** — six games, generated entirely from code.

![six games](docs/screens.png)

Slots · Plinko · Mines · Blackjack · Roulette · Stairs
...
Every multiplier is solved to a target house edge by `src/tables.py` and
`src/tables2.py`, and verified per-round by the test suite rather than
statistically.
